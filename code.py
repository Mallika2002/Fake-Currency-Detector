...
img = cv2.imread(r"C:\Users\malli\Downloads\Fake-currency-detection-Python-main\Fake-currency-detection-Python-main\Dataset\500\500front.jpeg")  # reading the image file
img1 = cv2.imread(r"C:\Users\malli\Downloads\Fake-currency-detection-Python-main\Fake-currency-detection-Python-main\Dataset\500\500back.jpeg")
...
cv2.imwrite('static/original_image.jpg', image)  # original images
cv2.imwrite('static/noise_filtered.jpg', img_median)   # filtered images
cv2.imwrite('static/gray_scale.jpg', gray)  # gray scale
cv2.imwrite('static/edge_detected.jpg', edges)  # edge detected
cv2.imwrite('static/segmented.jpg', th2)  # segmented
